...
REFERENCE_CORPUS: list[dict[str, object]] = [
    ...
    {"label": "Figma (design tool)", "scores": {"demand": 90, "competition": 40, "viability": 48}},
    {
    ...
    {"label": "Twilio (comms API)", "scores": {"demand": 82, "competition": 50, "viability": 45}},
    {
    ...
    {"label": "Deel (EOR SaaS)", "scores": {"demand": 85, "competition": 48, "viability": 52}},
    {"label": "Wiz (security SaaS)", "scores": {"demand": 88, "competition": 65, "viability": 48}},
    {
        "label": "Gong (sales intelligence)",
        "scores": {"demand": 74, "competition": 30, "viability": 38},
    },
    {"label": "Plaid (fintech API)", "scores": {"demand": 83, "competition": 45, "viability": 42}},
    {
